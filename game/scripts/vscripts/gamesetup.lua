if GameSetup == nil then GameSetup = class({}) end
...
function GameSetup:init()
    if IsInToolsMode() then -- debug build
        ...
        --         if item:GetAbilityName() == "item_tpscroll" and
        --             item:GetPurchaser() == nil then return false end
        --         return true
        --     end, self)
        ...
        ListenToGameEvent("game_rules_state_change",
                          Dynamic_Wrap(self, "OnStateChange"), self)
